...
contract Rhino5 {
    ...
    */
    ...
    address payable public charity; // charity's eth wallet address
    uint256 public charityFund; // charity's share over the money

    mapping (address => bool) public patrons; // storing patrons addresses
    mapping (address => uint256) public timeHeld; // storing the data of time held by each patron

    uint256 public timeAcquired; // holds the last time asset get buyed
    ...
    StewardState public state; // State of Steward

    /** @dev Construction function .
      * @param _charity Charity's wallet address.
      * @param _artwork Artwork's ERC721 address.
      */
    constructor(address payable _charity, address _artwork) public {
    ...
    */
    ...
    function _collectPatronage() public {
        ...
        if (state == StewardState.Owned) {
            ...
            charityFund = charityFund.add(collection);

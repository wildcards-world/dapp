            ...
            <div className='how-container vine-background'>
                <div className='how-content-container'>
                    <div className='how-content'>
                        ...
                        <p>
                            <span className='red-disclaimer'>For the first gorilla, Vitalik, the 30% Harberger tax will flow equally between both the conservation fund and the development of the platform. The future gorillas patronage fees will go directly to the relevant conservations' wallets.  </span>

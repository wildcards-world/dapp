...
class AnimalCardContainer extends Component<{}, { cards: any[], showStore: boolean, showCollection: boolean }> {
  ...
  renderCards() {
    ...
    const cards = this.state.cards.map((specificCard, index) => {
      return (
        <div key={'mykey' + index}>
    ...
    return [startingCard, ...cards, finalCard]
  }

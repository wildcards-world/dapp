    ...
    return (
      <Fragment>
        ...
        {window.ethereum !== undefined ? (
          <Fragment>
            <p>You will pay <ContractData contract="VitalikSteward" method="price" toEth /> ETH.<br /> Add your own sale price and amount you want to deposit for patronage: </p>
            <BuyForm contract="VitalikSteward" method="buy" labels={["Your Initial Sale Price"]} valueLabel="Your Initial Deposit" sendArgs={{}} />
          </Fragment>
        ) : (
            <Fragment>
